...
--
-- Table structure for table `sample_tbl2`
--

DROP TABLE IF EXISTS `sample_tbl2`;
...
--
-- Dumping data for table `sample_tbl2`
--

LOCK TABLES `sample_tbl2` WRITE;
/*!40000 ALTER TABLE `sample_tbl2` DISABLE KEYS */;
/*!40000 ALTER TABLE `sample_tbl2` ENABLE KEYS */;
UNLOCK TABLES;
